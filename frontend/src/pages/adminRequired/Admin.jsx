...
import ShiftEditorMenu from "../../components/ShiftEditorMenu";
...
function Admin() {
    ...
    const handleCancel = () => {
        ...
        const index =
            confirmEvent.target.parentElement.parentElement.dataset.index;
        const copy = [...teachersData];
    ...
    const sendUpdateRequest = () => {
        ...
        fetch(
            "./adminPanel/updateUser/" +
                teachersData[e.target.parentElement.parentElement.dataset.index]
                    .id,
            {
                headers: {
    ...
    return (
        ...
        >
            ...
            <Modal
                show={shiftEditorVisibility}
                onHide={closeShiftEditor}
                size="lg"
                aria-labelledby="contained-modal-title-vcenter"
                centered
            >
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={sendShiftUpdates}>
                        Confirm Changes
                    </Button>
                </Modal.Footer>
            </Modal>
